          ...
          >
            {navlinks.map((navlink) => (
              <a
                ...
                className={
                  navlink.href
                    ? "text-base font-medium text-primary relative before:absolute before:-bottom-1 before:h-0.5 before:w-full before:scale-x-0 before:transition before:bg-primary hover:before:scale-x-100 dark:hover:text-neutral dark:text-white dark:before:bg-white"
                    : "text-base font-medium text-primary relative dark:text-white dark:before:bg-white cursor-not-allowed"
                }
              >
                {navlink.name}
                {navlink.type === "new" && (
